...
router.post('/', async (req, res, next) => {
    ...
    try {
        ...
        const destinoResult = await pool.query(
            'SELECT cantidad FROM public."lugarInventario" WHERE "idSalon" = $1 AND "idTipodeMobiliario" = 2',
            [destino]
        );
        ...
        await pool.query(
            'UPDATE public."lugarInventario" SET cantidad = $1 WHERE "idSalon" = $2 AND "idTipodeMobiliario" = 2',
